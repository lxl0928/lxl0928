...
拥有8年云平台研发与团队管理经验，现任机器视觉云平台技术负责人，带领10人研发团队长期深耕视觉算法工程化、大规模视频流媒体系统、分布式AI推理平台架构设计与性能调优；近年主攻大模型应用、RAG向量检索，独立完成从0到1智能检索服务搭建。擅长结合云原生分布式技术实现AI视觉业务规模化落地，平衡技术深度与商业业务价值，长期聚焦多模态大模型 + 智能搜索赛道。
...
specialized in visual algorithm engineering, large-scale streaming media system, distributed AI inference platform architecture design & performance optimization.
Recent research focus: LLM application, RAG vector retrieval, built full intelligent search service from scratch.
...
2. 全面负责智慧城市AI云平台整体方案设计、技术攻坚，统筹视觉算法工程化、云平台架构、软硬件一体化产品研发与商业化落地；
3. 保障多个大型政府智慧城市项目高质量交付，支撑多条AI视觉业务线规模化落地。

### 上海数巧信息科技 | Simright

**后端工程师 | Backend Engineer**
2017.05 - 2018.05
1. 独立负责云端CAE仿真平台、协同研发系统后端架构开发；
2. 承担业务服务编码、分布式任务调度、线上运维体系搭建；
3. 支撑工业仿真软件云端化转型与企业客户落地交付。

## 🚀 核心项目：智慧城市社会治理AI视觉云平台 | Core Project
**Role：机器视觉云平台负责人 | Duration：2019.08 - 2026.07**
从0到1搭建整套AI视觉产品体系，完成多地市级智慧城市项目规模化商用落地。

### 1. 技术架构 | Tech Architecture
基于 Python / FastAPI / Tornado 构建全栈分布式云原生平台，核心技术栈：
- 中间件：Kafka、Redis、Celery、Nacos
- 存储：PostgreSQL、Elasticsearch、Milvus/Zilliz向量库、S3对象存储
- 容器编排：Docker、K8s
- 视觉模型：YOLO、ResNet、Transformer多模态视觉模型

自研五大核心引擎：
- MLS 算法推理引擎 | Model Inference Engine
- AISE 视图结构化引擎 | Image & Video Structuring Engine
- VS2C 云智能解析引擎 | Cloud Video Analysis Engine
- DMS 全生命周期数据平台 | Data Management Platform
- IVMS 视频综合管理平台 | Integrated Video Management Platform

### 2. 商业成果 | Business Achievement
落地数字点军、数智五峰、宜昌算力中心、川南人工智能算力中心等政府标杆项目
- 项目累计中标总额超5亿元，全部按期验收交付
...
- 人脸/人体/车辆实时结构化：6000+ QPS，平均响应 ≤ 100ms
...
## 🎯 职业发展方向 | Career Development Direction

深耕大模型多模态应用开发、RAG向量检索、智能搜索、Agent开发、大规模云原生AI推理平台架构方向；持续拓展机器视觉+大模型融合落地场景。
